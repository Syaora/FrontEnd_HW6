  ...
  _createClass(FormHandler, [{
    ...
    value: function addSubmitHandler(fn) {
      ...
      this.$formElement.on('submit', function (event) {
        ...
        var data = {};
        (0, _jquery2.default)(_this).serializeArray().forEach(function (item) {
...
var fh = new _formhandler2.default(FORM_SELECTOR);
fh.addSubmitHandler(function (fn) {});
